...
In each folder, there are many files (each file name is each function name we used, and if a file name begins with 'filtered_', the file name removing the 'filtered_' is the function name we used), and I will explain the file in detail as follows. In particular, I use the 'cos.txt' in 1-MR as the representative.
